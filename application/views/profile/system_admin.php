<style>
.myprofile{
     background: url(./assets/images/blueblack.png) no-repeat !important; 
     color: red;  
}
</style>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-lock" style="font-size:25px;font-weight: 600;"></i><small style="font-size:25px;font-weight: 600;"> <?php echo $this->lang->line('my_profile'); ?></small></h3>
                    ...
                    <div class="tab-content">                  
                        ...
                        <div  class="tab-pane fade in <?php if(isset($info)){ echo 'active'; }?>" id="tab_profile">
                            <div class="x_content">
                                ...
                                <div class="col-md-12">
                                  <div class="myprofile" >
                                    <div class="justify-content-center text-center" style="background-image:url('<?= base_url();?>assets/images/Requestbooks.png') "> 
                                        ...
                                        <?php } ?>
                                        <span style="color:black; font-weight: 800; font-family: sans-serif;">
