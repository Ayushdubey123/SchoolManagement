<div class="row ">
    ...
    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
        <div class="stats-count-inner" style="color: black;">
            <span class="count_top"><i class="fa fa-user"></i> <?php echo $this->lang->line('student'); ?></span>
    ...
    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
        <div class="stats-count-inner" style="color: black;">
            <span class="count_top"><i class="fa fa-pencil"></i> <?php echo $this->lang->line('teacher'); ?></span>
    ...
    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
        <div class="stats-count-inner" style=" color: black;">
            <span class="count_top"><i class=""></i> <?php echo $this->lang->line('guardian'); ?></span>
    ...
    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
        <div class="stats-count-inner" style="color: black;">
            <span class="count_top"><i class="fa fa-users"></i> <?php echo $this->lang->line('employee'); ?></span>
