...
<head>
    ...
    <link
            rel="icon"
            type="image/x-icon"
            href="assets/images/Black_Blue_Logo.png"
        /> 
    <title>Intra Education
...
#loader {
  background: url(/assets/images/White_Blue_Logo.png);
  width: 64px;
  height: 64px;
  position: relative;
  top: 50%;
...
<body>
 ...
 <header  class="fixed-top" 
        style='
        background: white; 
        box-shadow: 0px 1px 1px rgb(157 182 217 / 25%);;
        height: 74px;'
    >
        <div class="container" style='margin-top: -0.5rem;'>
            <nav class="navbar navbar-expand-lg navbar-light">
                <div>
                    <a href='#'>
                        <img src="assets/images/Black_Blue_Logo.png" alt="image not found" style='width:80px'/>
                    </a>
                ...
                <div class="collapse navbar-collapse" id="navbarScroll" >
                    <ul class="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll">
                        <li class="nav-item">
                            <a href="#" id="mpopupLink"  class='nav-link active' style='color:black;'>Help</a>          
                        </li>
                    </ul>
    ...
    <div class="w3l-grids-block-5" style='padding-top: 7rem; background-color: #f8f9fa; z-index: 2147483647; 
    height:100vh;
    '>
        <div class="container py-md-5 py-4">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-5">
                    <div class='card' style='border-radius: 3%; height: 28rem; box-shadow:rgba(0, 0, 0, 0.35) 0px 5px 15px'>
                            <div class='body'>
                                
                                <div class="title-main mx-auto mb-md-5 mb-4" style="max-width:500%; padding: 10%;">
                                        <h6 class="text-capitalize text-center" style='color:black'>Login</h6>
                                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                                <p class="red" style="color: red;"><?php echo $this->session->flashdata('error'); ?></p>
                                                <p class="green"  style="color: #000;"><?php echo $this->session->flashdata('success'); ?></p>
                                      </div>
                                      ...
                                      <?php echo form_open(site_url('auth/login'), array('name' => 'login', 'id' => 'login'), ''); ?>
                                        ...
                                        <div class="form-group p-1">
                                          ...
                                          <!-- <p id="emailHelp" class="form-text text-muted" style=' 
                                            font-size: 70%;
                                          '>
                                        By login, I accept the Terms of Service and Privacy Policy
                                          ...
                                          '>
                                          I accept the   
                                                <a href='http://intraedu.in/termsandservice' style='color:#00adad'>Terms of Service</a>  
                                            and  
                                            <a href='http://intraedu.in/privacyandpolicy' style='color:#00adad'>Privacy Policy</a>
                                          </p>
