<div class="col-md-3 <?php echo $this->enable_rtl ? 'right_col' : 'left_col'; ?>">
    <div class="<?php echo $this->enable_rtl ? 'right_col' : 'left_col'; ?> scroll-view"  style="background-color:#B0A8FF;">
        <div class="navbar nav_title" style="border: 0; ">
            <a href="<?php echo site_url('dashboard'); ?>">
                ...
                <?php if($this->global_setting->brand_logo){ ?>
                      <img class="logo" src="<?php echo UPLOAD_PATH.'logo/'.$this->global_setting->brand_logo; ?>" style="max-width: 65px;" alt="IntraEdu">
                <?php }else{ ?>
                ...
                <ul class="nav side-menu" >                    
                  ...
                  <!--   <?php if(has_permission(VIEW, 'theme', 'theme')){ ?>
                    ...
                    if(has_permission(VIEW, 'administrator', 'setting') ||
                        ...
                        <li><a><i class="fa fa-plus"></i> <?php echo $this->lang->line('administrator'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                ...
                                <?php if(has_permission(VIEW, 'administrator', 'year')){ ?>   
                                 ...
                                 <?php } ?>
                                  <?php if(has_permission(VIEW, 'academic', 'classes')){ ?> 
                                    <li><a href="<?php echo site_url('academic/branch'); ?>">Branch</a></li>
                                <?php } ?> 
                    ...
                    <?php } ?> 
                     ...
                     <?php if(has_permission(VIEW, 'frontoffice', 'purpose') ||
                        ...
                        <li><a> <i class="fa fa-briefcase"></i><?php echo $this->lang->line('front_office'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">                            
                                 <?php if(has_permission(VIEW, 'frontoffice', 'purpose')){ ?>   
                    ...
                    <li><a><i class="fa fa-edit"></i><?php echo $this->lang->line('human_resource'); ?> <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                    ...
                    <?php if(has_permission(VIEW, 'teacher', 'teacher')){ ?>
                        <li><a href="<?php echo site_url('teacher/index'); ?>"><i class="fa fa-user"></i> <?php echo $this->lang->line('teacher'); ?></a> </li>  
                    <?php } ?>
                    ...
                    <?php if(has_permission(VIEW, 'academic', 'subject')){ ?> 
                        <li><a  href="<?php echo site_url('academic/subject/index'); ?>"><i class="fa fa-book"></i> <?php echo $this->lang->line('subject'); ?> </a></li>
                    <?php } ?>     
                    ...
                    <?php if(has_permission(VIEW, 'academic', 'material')){ ?> 
                       <li><a  href="<?php echo site_url('academic/material/index'); ?>"><i class="fa fa-file"></i> <?php echo $this->lang->line('study_material'); ?></a> </li> 
                    <?php } ?>    
                   
                    <?php if(has_permission(VIEW, 'academic', 'routine')){ ?>
                       <li> <a  href="<?php echo site_url('academic/routine/index'); ?>"> <i class="fa fa-clock-o"></i>Time Table</a></li>
                    <?php } ?>   
                                        
                    <?php if(has_permission(VIEW, 'guardian', 'guardian')){ ?>    
                        <li><a href="<?php echo site_url('guardian/index'); ?>"><i class="fa fa-male"></i> <?php echo $this->lang->line('guardian'); ?></a> </li>
                    <?php } ?>
                           ...
                           <li><a><i class="fa fa-group"></i> <?php echo $this->lang->line('manage_student'); ?> <span class="fa fa-chevron-down"></span></a>
                               <ul class="nav child_menu">
                                    ...
                                    <?php if(has_permission(ADD, 'student', 'student')){ ?>
                                     ...
                                     <?php } ?>
                                   <!--    <?php if(!has_permission(ADD, 'student', 'online')){ ?>
                                        <li><a href="<?php echo site_url('online/add'); ?>">Online</a></li>
                                     <?php } ?>  -->
                    ...
                    <?php if(has_permission(VIEW, 'library', 'book') || 
                        ...
                        <li><a><i class="fa fa-book"></i> <?php echo $this->lang->line('library'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                ...
                                <?php } ?>
                                  <?php if(!has_permission(VIEW, 'library', 'b_bulk')){ ?> 
                                    <li><a href="<?php echo site_url('library/b_bulk/add'); ?>">Bulk Book</a></li>
                                <?php } ?>
