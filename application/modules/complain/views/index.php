<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-commenting-o" style="font-size:25px"></i>&nbsp;<small style="font-size:25px; font-weight:600">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(VIEW, 'complain', 'complain')){ ?>
                                                    <a  onclick="get_complain_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-complain-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size:20px"></i> 
                                                      <!--   <?php echo $this->lang->line('view'); ?> -->
                                                         </a>
                                                <?php  } ?>

                                                <?php if(has_permission(EDIT, 'complain', 'complain')){ ?>
                                                    <a href="<?php echo site_url('complain/edit/'.$obj->id); ?>" class="btn btn-info btn-xs" style="background-color:blue;"><i class="fa fa-pencil-square-o" style="font-size:20px"></i> 
                                                        <!-- <?php echo $this->lang->line('update'); ?> -->
                                                         </a>
                                                <?php  } ?>
                                                
                                                <?php if(has_permission(DELETE, 'complain', 'complain')){ ?>
                                                    <a href="<?php echo site_url('complain/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red;"><i class="fa fa-trash-o" style="font-size:20px"></i> 
                               ...
                               <?php echo form_open_multipart(site_url('complain/edit/'.$complain->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($complain->title) ?  $complain->title : ''; ?>"  required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>
