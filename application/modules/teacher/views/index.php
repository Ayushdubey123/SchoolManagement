<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-male" style="font-size:25px"></i><small style="font-size:25px;font-weight:600;"> <?php echo $this->lang->line('manage_teacher'); ?></small></h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                 ...
                                                 <?php if(has_permission(VIEW, 'teacher', 'teacher')){ ?>
                                                    <a  onclick="get_teacher_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-teacher-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size:20px"></i> 
                                                        <!-- <?php echo $this->lang->line('view'); ?> -->
                                                     </a><br/>
                                                <?php } ?>

                                                <?php if(has_permission(EDIT, 'teacher', 'teacher')){ ?>
                                                    <a href="<?php echo site_url('teacher/edit/'.$obj->id); ?>" class="btn btn-info btn-xs" style="background-color: blue;"><i class="fa fa-pencil-square-o" style="font-size:20px"> </i>
                                                     <!-- <?php echo $this->lang->line('edit'); ?>  --> 
                                                 </a><br/>
                                                <?php } ?> 
                                               
                                                <?php if(has_permission(DELETE, 'teacher', 'teacher')){ ?>
                                                    <a href="<?php echo site_url('teacher/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color: red;"><i class="fa fa-trash-o" style="font-size:20px"></i> 
