<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bullhorn" style="font-size:25px"></i>&nbsp;<small style="font-size:25px;font-weight: 600"> 
                    <?php echo $this->lang->line('manage_notice'); ?></small></h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                  ...
                                                  <?php if(has_permission(VIEW, 'announcement', 'notice')){ ?>
                                                    <a  onclick="get_notice_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-notice-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size:20px"></i> 
                                                        <!-- <?php echo $this->lang->line('view'); ?> -->
                                                         </a>
                                                <?php } ?>

                                                <?php if(has_permission(EDIT, 'announcement', 'notice')){ ?>
                                                    <a href="<?php echo site_url('announcement/notice/edit/'.$obj->id); ?>" class="btn btn-info btn-xs" style="background-color:blue;"><i class="fa fa-pencil-square-o" style="font-size:20px"></i> 
                                                        <!-- <?php echo $this->lang->line('edit'); ?> --> 
                                                    </a>
                                                <?php } ?>
                                              
                                                <?php if(has_permission(DELETE, 'announcement', 'notice')){ ?>
                                                    <a href="<?php echo site_url('announcement/notice/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red;"><i class="fa fa-trash-o" style="font-size:20px"></i> 
