                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(VIEW, 'announcement', 'holiday')){ ?>
                                                    <a  onclick="get_holiday_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-holiday-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size:20px"></i> 
                                                        <!-- <?php echo $this->lang->line('view'); ?> -->
                                                         </a>
                                                <?php } ?>

                                                <?php if(has_permission(EDIT, 'announcement', 'holiday')){ ?>
                                                    <a href="<?php echo site_url('announcement/holiday/edit/'.$obj->id); ?>" class="btn btn-info btn-xs" style="background-color:blue ;"><i class="fa fa-pencil-square-o" style="font-size:20px"></i> 
                                                       <!--  <?php echo $this->lang->line('edit'); ?> --> 
                                                    </a>
                                                <?php } ?>
                                               
                                                <?php if(has_permission(DELETE, 'announcement', 'holiday')){ ?>
                                                    <a href="<?php echo site_url('announcement/holiday/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red;"><i class="fa fa-trash-o" style="font-size:20px"></i>
