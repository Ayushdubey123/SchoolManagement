<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bar-chart" style="font-size:25px"></i>&nbsp;<small style="font-size:25px;font-weight:600"> <?php echo $this->lang->line('teacher_yearly_attendance_report'); ?></small></h3>                
