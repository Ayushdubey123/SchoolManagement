<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-upload" style="font-size: 25px;"></i>&nbsp;<small style="font-size: 25px; font-weight:600;">
                 <!-- <?php echo $this->lang->line('manage_submission'); ?> -->
                     Submission
                 </small></h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(VIEW, 'assignment', 'submission')){ ?>
                                                    <a  onclick="get_submission_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-submission-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size:20px"></i>
                                                ...
                                                <?php if(has_permission(EDIT, 'assignment', 'submission')){ ?>
                                                    <a href="<?php echo site_url('assignment/submission/edit/'.$obj->id); ?>" class="btn btn-info btn-xs" style="background-color:blue;"><i class="fa fa-pencil-square-o" style="font-size:20px"></i>
                                                     <!-- <?php echo $this->lang->line('edit'); ?>  -->
                                                 </a>
                                                <?php  } ?>
                                                
                                                <?php if(has_permission(DELETE, 'assignment', 'submission')){ ?>
                                                    <a href="<?php echo site_url('assignment/submission/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red;"><i class="fa fa-trash-o" style="font-size:20px"></i> 
