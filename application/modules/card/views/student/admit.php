<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-code" style="font-size: 25px"></i>&npsp;<small style="font-size: 25px; font-weight: 600">
                 <!-- <?php echo $this->lang->line('generate_student_admit_card'); ?> -->
                    Student Admit Card 
                 </small></h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="form-group"><br/>
                            <button id="send" type="submit" class="btn btn-success" style="background-color:purple;color:white;"><?php echo $this->lang->line('generate'); ?></button>
                        </div>
                    </div>
