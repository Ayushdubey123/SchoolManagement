<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-check" style="font-size:25px"></i><small style="font-size:25px; font-weight:25px;">&nbsp;Log</small></h3> 
                                        ...
                                        ?>
                                            <?php foreach ($activity_logs as $obj) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>                                                 
                                                        <?php if(has_permission(DELETE, 'administrator', 'activitylog')){ ?>    
                                                            <a href="<?php echo site_url('administrator/activitylog/delete/'.$obj->id); ?>"  onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red;"><i class="fa fa-trash-o" style="font-size:20px;"></i> 
