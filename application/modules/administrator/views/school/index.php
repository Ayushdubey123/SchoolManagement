<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-home" style="font-size:25px;"></i>&nbsp;<small style="font-size:25px; font-weight: 600;">Add School</small></h3>
                                    ...
                                    <?php $count = 1; if(isset($schools) && !empty($schools)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php } ?>
                                               ...
                                               <td>
                                          <?php if($obj->qrcode){ ?>
                                            <img class="logo-identifier"  src="<?php echo UPLOAD_PATH; ?>/school_qrcode/<?php echo $obj->qrcode; ?>" alt="" width="80" /><br/><br/>
                                            <a href="<?php echo UPLOAD_PATH; ?>/school_qrcode/<?php echo $obj->qrcode; ?>" download style="margin-left:10px;margin-top:2rem;"> Download     </a> 
                                             <?php } ?>
                                            ...
                                            <td>
                                                <?php if(has_permission(VIEW, 'administrator', 'school')){ ?>
                                                    <a  onclick="get_school_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-school-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="color: white;font-size: 20px; "></i>  </a><br/>
                                                <?php } ?>    
                                                <?php if(has_permission(EDIT, 'administrator', 'school')){ ?>
                                                    <a href="<?php echo site_url('administrator/school/edit/'.$obj->id); ?>" class="btn btn-info btn-xs" style="background-color: blue;"><i class="fa fa-pencil-square-o" style="font-size: 20px; "></i> 
                                                        <!-- <?php echo $this->lang->line('edit'); ?> --> 
                                                    </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'administrator', 'school')){ ?>
                                                    <a href="<?php echo site_url('administrator/school/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color: red;"><i class="fa fa-trash-o" style="font-size: 20px; "></i>
                               ...
                               <?php echo form_open_multipart(site_url('administrator/school/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">
                                   <!--  <div class="col-md-3 col-sm-3 col-xs-12">
                                      ...
                                      <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="branch">School Have Branch</label>
                                            <select  class="form-control col-md-7 col-xs-12"  name="branch" required="required">
                                                <option value="0" <?php if(isset($post) && $post['branch'] == 0){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                                <option value="1" <?php if(isset($post) && $post['branch'] == 1){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                            </select>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="school_upi">School Upi ID</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="school_upi"  id="school_upi" value="<?php echo isset($post['school_upi']) ?  $post['school_upi'] : ''; ?>" placeholder="School Upi Id "  type="text" autocomplete="off" required>
                                            <div class="help-block"><?php echo form_error('school_upi'); ?></div> 
                                        </div>
                                    </div>
                               ...
                               <?php echo form_open_multipart(site_url('administrator/school/edit/'.$school->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="school_upi">School Upi ID</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="school_upi"  id="school_upi" value="<?php echo isset($school) ? $school->school_upi : ''; ?>" placeholder="School Upi"  type="text" autocomplete="off" required>
                                            <div class="help-block"><?php echo form_error('school_upi'); ?></div> 
                                        </div>
                                    </div>  
                                </div>
