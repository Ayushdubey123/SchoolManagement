<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-users" style="font-size: 25px;"></i>&nbsp;<small style="font-size: 25px; font-weight: 600;">Role Permission</small></h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(EDIT, 'administrator', 'permission')){ ?>  
                                                    <a href="<?php echo site_url('administrator/permission/index/'.$obj->id); ?>" class="btn btn-success btn-xs" style="background-color: cyan; color:black;"><i class="fa fa-folder-open-o" style="color: black;"></i> <?php echo $this->lang->line('role_permission'); ?> 
