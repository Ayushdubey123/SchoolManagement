<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-user" style="font-size: 25px;"></i><small style="font-size:25px; font-weight:600">&nbsp;User</small></h3>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if(has_permission(EDIT, 'administrator', 'user')){ ?>
                                                        <?php if($obj->login_status){ ?>
                                                            <a class="btn btn-success btn-xs"style="background-color:green;">  <i class="fa fa-check"> <?php echo $this->lang->line('login'); ?> <?php echo $this->lang->line('active'); ?></i></a>
                                                        ...
                                                        <?php }else{ ?>
                                                            ...
                                                            <a class="btn btn-success btn-xs fn_update_status"  id="<?php echo $obj->user_id; ?>" itemid="1" style="background-color:green;"><i class="fa fa-check"> <?php echo $this->lang->line('activate_now'); ?></i></a>
                                                        <?php } ?>                                                        
                                                        <a href="<?php echo site_url($path.'/edit/'.$obj->id); ?>" class="btn btn-info btn-xs" style="background-color:blue"><i class="fa fa-pencil-square-o" style="font-size:20px;"> <!-- <?php echo $this->lang->line('edit'); ?> -->
                                                            
                                                        </i></a>
                                                    <?php } ?>                                          
                                                 
                                                    <a  onclick="get_user_modal(<?php echo $obj->id; ?>,'<?php echo $path; ?>', '<?php echo $type; ?>');"  data-toggle="modal" data-target=".bs-user-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size: 20px;"></i> 
