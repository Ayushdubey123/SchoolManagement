<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-envelope" style="font-size: 25px;"></i>&nbsp;<small style="font-size:25px; font-weight:600;">Email Setting</small></h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(VIEW, 'administrator', 'emailsetting')){ ?>
                                                    <a  onclick="get_email_setting_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-email-setting-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size:20px"></i>
                                                     <!-- <?php echo $this->lang->line('view'); ?> -->
                                                      </a>
                                                <?php } ?>
                                                <?php if(has_permission(EDIT, 'administrator', 'emailsetting')){ ?>
                                                    <a href="<?php echo site_url('administrator/emailsetting/edit/'.$obj->id); ?>" class="btn btn-success btn-xs" style="background-color:blue;"><i class="fa fa-edit" style="font-size:20px"></i> 
                                                       <!--  <?php echo $this->lang->line('edit'); ?> -->
                                                         </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'administrator', 'emailsetting')){ ?>
                                                    <a href="<?php echo site_url('administrator/emailsetting/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red;"><i class="fa fa-trash-o" style="font-size:20px"></i> 
