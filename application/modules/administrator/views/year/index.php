<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-calendar" style="font-size: 25px"></i>&nbsp;<small style="font-size: 25px; font-weight: 600;">Academic Year</small></h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(EDIT, 'administrator', 'year')){ ?>
                                                    <a href="<?php echo site_url('administrator/year/edit/'.$obj->id); ?>" class="btn btn-info btn-xs" style="background-color:blue;"><i class="fa fa-pencil-square-o" style="font-size:20px;"></i>
                                                     <!-- <?php echo $this->lang->line('edit'); ?> --> 
                                                 </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'administrator', 'year')){ ?>
                                                    <?php if(!$obj->is_running){ ?>
                                                    <a href="<?php echo site_url('administrator/year/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:blue;"><i class="fa fa-trash-o" style="font-size:20px;"></i>
