<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-book" style="font-size:25px"></i>&nbsp;<small style="font-size:25px; font-weight:600;"> 
                    <!-- <?php echo $this->lang->line('manage_book'); ?> -->
                        Book
                    </small></h3>
                                    ...
                                    <?php $count = 1; if(isset($books) && !empty($books)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    <a  onclick="get_book_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-book-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size:20px"></i> 
                                                      <!--   <?php echo $this->lang->line('view'); ?> --> 
                                                    </a>
                                                <?php } ?>

                                                <?php if(has_permission(EDIT, 'library', 'book')){ ?>
                                                    <a href="<?php echo site_url('library/book/edit/'.$obj->id); ?>" class="btn btn-info btn-xs" style="background-color:blue;"><i class="fa fa-pencil-square-o" style="font-size:20px"></i> 
                                                        <!-- <?php echo $this->lang->line('edit'); ?> -->
                                                         </a>
                                                <?php } ?>
                                            
                                                <?php if(has_permission(DELETE, 'library', 'book')){ ?>
                                                    <a href="<?php echo site_url('library/book/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red;"><i class="fa fa-trash-o" style="font-size:20px"></i> 
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('library/book/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 fn_get_class" name="class_id" id="class_id" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            <?php if(isset($classes) && !empty($classes)){ ?>
                                                <?php foreach($classes as $obj){ ?>
                                                    <option value="<?php echo $obj->id; ?>"><?php echo $obj->title; ?> [<?php echo $obj->custom1_id; ?>]</option>
                                                <?php } ?>
                                            <?php } ?>
                                        </select>
                               ...
                               <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="stream">Stream
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="stream"  id="stream" value="<?php echo isset($post['stream']) ?  $post['stream'] : ''; ?>" placeholder="stream"  type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="publisher">Publisher
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="publisher"  id="publisher" value="<?php echo isset($post['publisher']) ?  $post['publisher'] : ''; ?>" placeholder="publisher"  type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('publisher'); ?></div>
                                    </div>
                                </div>
                               ...
                               <?php echo form_open_multipart(site_url('library/book/edit/'.$book->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                   ...
                                   <!--  Hello -->
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="stream"  id="stream" value="<?php echo isset($book->stream) ?  $book->stream : ''; ?>" placeholder="<?php echo $this->lang->line('stream'); ?>" type="text" autocomplete="off"/>
                                        <div class="help-block"><?php echo form_error('stream'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="publisher"  id="publisher" value="<?php echo isset($book->publisher) ?  $book->publisher : ''; ?>" placeholder="<?php echo $this->lang->line('publisher'); ?>" type="text" autocomplete="off"/>
                                        <div class="help-block"><?php echo form_error('publisher'); ?></div>
                                    </div>
                                </div>
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
    ...
    $('#class_id').on('change', function(){
        ...
        get_library_member_by_school(school_id,$(this).val());
    ...
    function get_class_by_school(school_id){
        ...
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('library/issue/get_class_by_school'); ?>",
            data   : { school_id:school_id},               
            async  : false,
            success: function(response){                                                   
               if(response)
    ...
    function get_library_member_by_school(school_id,class_id){
