<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-book" style="font-size:25px"></i><small style="font-size:25px"> 
                    <!-- <?php echo $this->lang->line('manage_library_member'); ?> -->
                        Library Member
                    </small></h3>
                                        ...
                                        <tr  style="<?php if($obj->status_type !='regular'){ echo 'background:#dde3e8;';} ?>">
                                            ...
                                            <td>
                                                <?php if(has_permission(DELETE, 'library', 'member')){ ?>
                                                    <a href="<?php echo site_url('library/member/delete/'.$obj->lm_id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red;"><i class="fa fa-trash-o" style="font-size:20px"></i> 
