<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-download" style="font-size: 25px"></i>&nbsp;<small style="font-size: 25px; font-weight:600"> 
                    <!-- <?php echo $this->lang->line('manage_bulk_admission'); ?> -->
                        Bulk Book
                    </small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                        ...
                        <div  class="tab-pane fade in active" id="tab_add_bulk_student">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('library/b_bulk/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">                                      
                                    ...
                                    <?php } ?>
                                     ...
                                     <div class="col-md-2 col-sm-2 col-xs-12">
                                         <div class="item form-group">
                                             <label for="">&nbsp;</label>
                                            <a href="<?php echo ASSET_URL; ?>csv/bulk_student.csv"  class="btn btn-success btn-md" style="background-color:#7f289e"><?php echo $this->lang->line('generate_csv'); ?></a>
                                         </div>
                                     </div> 
                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                         <div class="item form-group">
                                             <label ><?php echo $this->lang->line('csv_file'); ?>&nbsp;</label>
                                            <div class="btn btn-default btn-file" style="background-color:black; color:white">
                                                <i class="fa fa-paperclip" style="color:white"></i> <?php echo $this->lang->line('upload'); ?>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="instructions"><strong><?php echo $this->lang->line('instruction'); ?>: </strong> 
                                        <ol>
                                            ...
                                            <li><?php echo $this->lang->line('academic_group'); ?>: [ science, arts, commerce, school ]</li>
