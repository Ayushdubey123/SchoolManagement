        ...
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-book" style="font-size:25px;"></i><small style="font-size:25px;font-weight: 600">
                 <!-- <?php echo $this->lang->line('manage_issue_and_return'); ?> -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(EDIT, 'library', 'issue')){ ?>
                                                    ...
                                                    <a href="javascript:void(0);" class="btn btn-success btn-xs" style="background-color:green;"><i class="fa fa-retweet"></i> <?php echo $this->lang->line('return'); ?> </a>
                                                    <?php }else{ ?>
                                                        <?php if(has_permission(EDIT, 'library', 'issue')){ ?>
                                                        <a href="javascript:void(0);" onclick="return_book_by_id('<?php echo $obj->issue_id; ?>', '<?php echo $obj->id; ?>');" class="btn btn-info btn-xs" style="background-color:purple;"><i class="fa fa-share"></i> <?php echo $this->lang->line('return_this'); ?></a>
                                                        <?php } ?>
                                                    <?php } ?>
                                                <?php } ?>
                                            </td>
                               ...
                               <div class="item form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <button id="fn_send" type="submit" class="btn btn-success" style="background-color:blue;color: white"><?php echo $this->lang->line('issue'); ?></button>
                                    </div>
                                </div>
                                <?php echo form_close(); ?>
                            </div>
