...
class Book extends MY_Controller {
    ...
    * ********************************************************** */
    private function _prepare_book_validation() {
        ...
        $this->form_validation->set_rules('feculty', $this->lang->line('feculty'), 'trim');
        $this->form_validation->set_rules('stream', $this->lang->line('stream'), 'trim');
        ...
        $this->form_validation->set_rules('author', $this->lang->line('author'), 'trim');
         $this->form_validation->set_rules('publisher', $this->lang->line('publisher'), 'trim');
