...
class Issue extends MY_Controller {
    ...
    * ********************************************************** */
    public function get_book_by_id() {
       ...
       public function get_class_by_school() {
        ...
        $class_id = $this->input->post('school_id');
        $class = $this->book->get_list('classes', array('school_id' => $class_id));
    ...
    * ********************************************************** */
    ...
    public function get_library_member_by_school() {
        ...
        $membrs =  $this->book->get_library_member_list($is_library_member = 1, $school_id,$class_id);
