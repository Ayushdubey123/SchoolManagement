<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bus" style="font-size:25;"></i><small style="font-size:25; font-weight: 600;">
                 <?php echo $this->lang->line('manage_route'); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(VIEW, 'transport', 'route')){ ?>
                                                    <a href="javascript:void(0);" onclick="get_route_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-route-modal-lg" class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size:20px"></i> 
                                                        <!-- <?php echo $this->lang->line('view'); ?> --> 
                                                    </a><br/>
                                                <?php } ?>

                                                <?php if(has_permission(EDIT, 'transport', 'route')){ ?>
                                                    <a href="<?php echo site_url('transport/route/edit/'.$obj->id); ?>" class="btn btn-info btn-xs" style="background-color:blue;"><i class="fa fa-pencil-square-o" style="font-size:20px"></i> 
                                                        <!-- <?php echo $this->lang->line('edit'); ?>  -->
                                                    </a>
                                                <?php } ?>
                                                
                                                <?php if(has_permission(DELETE, 'transport', 'route')){ ?>
                                                    <a href="<?php echo site_url('transport/route/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red;"><i class="fa fa-trash-o" style="font-size:20px"></i>
