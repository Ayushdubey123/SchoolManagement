<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-user" style="font-size: 25px"></i><small style="font-size: 25px; font-weight:600">
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>  
                                    ...
                                    <tr style="<?php if($obj->status_type !='regular'){ echo 'background:#f9bfbf; color:#000000;';} ?>">
                                            ...
                                            <td>
                                                <?php  if($obj->photo != ''){ ?>
                                                <img src="<?php echo UPLOAD_PATH; ?>/student-photo/<?php echo $obj->photo; ?>" alt="" width="60" style="border-radius:5px;" /> 
                                                <?php }else{ ?>
                                                <img src="<?php echo IMG_URL; ?>/default-user.png" alt="" width="60" style="border-radius:5px;" /> 
                                                <?php } ?>
                                            </td>
                                            ...
                                            <td>
                                                 ...
                                                 <?php if(has_permission(VIEW, 'student', 'student')){ ?>
                                                        <a href="javascript:void(0);" onclick="get_student_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-student-modal-lg" class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size:20px"></i> 
                                                           <!--  <?php echo $this->lang->line('view'); ?>  -->
                                                        </a>
                                                    <?php } ?>

                                                <?php if(has_permission(EDIT, 'student', 'student') && $obj->status_type == 'regular'){ ?>
                                                    <a href="<?php echo site_url('student/edit/'.$obj->id); ?>" class="btn btn-info btn-xs" style="background-color: blue;"><i class="fa fa-pencil-square-o" style="font-size:20px"></i>
                                                    <!--  <?php echo $this->lang->line('edit'); ?> --> 
                                                 </a>
                                                <?php } ?>
                                              
                                                <?php if(has_permission(DELETE, 'student', 'student') && $obj->status_type == 'regular'){ ?>
                                                        <br/><a href="<?php echo site_url('student/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color: red;"><i class="fa fa-trash-o" style="font-size:20px"></i>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_student">
                            <div class="x_content"> 
                               ...
                               <div class="row">                  
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            <label  for="aadharcard_no">Aadharcard No<span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="aadharcard_no" data-type="adhaar-number" maxLength="19"  id="aadharcard_no" value="<?php echo isset($post['aadharcard_no']) ?  $post['aadharcard_no'] : ''; ?>" placeholder="Aadharcard No" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('aadharcard_no'); ?></div>
                                         </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_student">
                            ...
                            <?php echo form_open_multipart(site_url('student/edit/'. $student->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                               ...
                               <div class="row">                  
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                              <label for="aadharcard_no">Aadharcard No</label>
                                              <input  class="form-control col-md-7 col-xs-12"  name="aadharcard_no" data-type="adhaar-number" maxLength="19"  id="aadharcard_no" value="<?php echo isset($student->aadharcard_no) ?  $student->aadharcard_no : ''; ?>" placeholder="Aadharcard No" type="text" autocomplete="off">
                                               <div class="help-block"><?php echo form_error('aadharcard_no'); ?></div>
                                         </div>
                                     </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
