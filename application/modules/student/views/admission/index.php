<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-users" style="font-size: 25px"></i><small style="font-size: 25px; font-weight: 600;"> 
                    <!-- <?php echo $this->lang->line('manage_online_admission'); ?>  -->
                    Online Admission
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(VIEW, 'student', 'admission')){ ?>
                                                    <a  onclick="get_admission_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-admission-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size:20px"></i>
                                                ...
                                                <?php if(has_permission(DELETE, 'student', 'admission')){ ?>
                                                    <a href="<?php echo site_url('student/admission/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color: blue;"><i class="fa fa-trash-o" style="font-size:20px"></i> 
