        ...
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-file-text-o" style="font-size: 25px"></i>&nbsp;<small style="font-size: 25px; font-weight:600">
                 <!-- <?php echo $this->lang->line('manage_result_card'); ?> -->
                     Result Card
                 </small></h3>
            ...
            <div class="row no-print">
                <div class="col-xs-12 text-right">
                    <button class="btn btn-default " onclick="window.print();" style="background-color:blue;color:white"><i class="fa fa-print" style="color: white;"></i>
