<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-envelope-o" style="font-size:25px"></i><small style="font-size:25px; font-weight:600">
                 <!-- <?php echo $this->lang->line('manage_result_email'); ?> -->
                     Result Email
                 </small></h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(VIEW, 'exam', 'resultemail')){ ?>
                                                    <a  onclick="get_email_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-email-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size:20px"></i> 
                                                        <!-- <?php echo $this->lang->line('view'); ?> -->
                                                         </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'exam', 'resultemail')){ ?>    
                                                    <a href="<?php echo site_url('exam/resultemail/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color: white;"><i class="fa fa-trash-o" style="font-size:20px"></i> 
