<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-clock-o" style="font-size: 25px"></i>&nbsp;<small style="font-size: 25px; font-weight: 600">
                 <!-- <?php echo $this->lang->line('manage_exam_term'); ?>  -->
                    Exam Term
             </small></h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(EDIT, 'exam', 'exam')){ ?>
                                                    <a href="<?php echo site_url('exam/edit/'.$obj->id); ?>" class="btn btn-info btn-xs" style="background-color: blue;"><i class="fa fa-pencil-square-o" style="font-size:20px"></i>
                                                     <!-- <?php echo $this->lang->line('edit'); ?> -->
                                                      </a>
                                                <?php } ?>                                               
                                                <?php if(has_permission(DELETE, 'exam', 'exam')){ ?>
                                                    <a href="<?php echo site_url('exam/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('conirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color: red;"><i class="fa fa-trash-o" style="font-size:20px"></i>
