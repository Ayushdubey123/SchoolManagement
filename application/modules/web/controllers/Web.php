 ...
 * @type            : Class
 * @class name      : Web
 * @description     : Manage frontend website.a  
...
class Web extends CI_Controller {
    ...
    public function school($id = null){
     ...
     // echo "here".$id;die;            
        ...
        if(!empty($school)){
            ...
            $this->session->set_userdata('school_data', $school);
    ...
    * ********************************************************** */
    public function admission_form() {
       ...
       if($this->session->userdata('front_school_id')){           
            $this->data['school']=$this->session->userdata('school_data');
           ...
           if(isset($this->data['school']->enable_online_admission) && $this->data['school']->enable_online_admission){
            if($_POST){
                ...
                $this->session->set_flashdata('success', 'User Inserted successfully');
                    ...
                    $this->session->set_userdata('error', 'Apply Failed');
    ...
    * ********************************************************** */
    ...
    private function _prepare_admission_validation() {
        ...
        $this->form_validation->set_rules('father_phone', $this->lang->line('father_phone'), 'trim|required');
        $this->form_validation->set_rules('father_education', $this->lang->line('father_education'), 'trim|required');
        $this->form_validation->set_rules('father_profession', $this->lang->line('father_profession'), 'trim|required');
        $this->form_validation->set_rules('father_designation', $this->lang->line('father_designation'), 'trim|required');
        $this->form_validation->set_rules('mother_name', $this->lang->line('mother_name'), 'trim|required');
        $this->form_validation->set_rules('mother_phone', $this->lang->line('mother_phone'), 'trim|required');
        $this->form_validation->set_rules('mother_education', $this->lang->line('mother_education'), 'trim|required');
        $this->form_validation->set_rules('mother_profession', $this->lang->line('mother_profession'), 'trim|required');
        $this->form_validation->set_rules('mother_designation', $this->lang->line('mother_designation'), 'trim|required');
