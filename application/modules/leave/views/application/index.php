<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bell-o" style="font-size: 25px"></i>&nbsp;<small style="font-size:25px; font-weight:600"> 
                    <!-- <?php echo $this->lang->line('manage_leave_application'); ?> -->
                       Leave Applecation 
                    </small></h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>                                                
                                               <?php if(has_permission(EDIT, 'leave', 'approve')){ ?>
                                                    <a href="<?php echo site_url('leave/approve/update/'.$obj->id); ?>" title="<?php echo $this->lang->line('approve'); ?>" class="btn btn-success btn-xs"><i class="fa fa-check-square-o"></i>
                                                ...
                                                <?php if(has_permission(VIEW, 'leave', 'application')){ ?>
                                                    <a  onclick="get_application_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-application-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size:20px"></i> 
                                                ...
                                                <?php if(has_permission(EDIT, 'leave', 'application')){ ?>
                                                    <a href="<?php echo site_url('leave/application/edit/'.$obj->id); ?>" title="<?php echo $this->lang->line('edit'); ?>" class="btn btn-info btn-xs" style="background-color:blue;"><i class="fa fa-pencil-square-o" style="font-size:20px"></i> 
                                                        <!-- <?php echo $this->lang->line('edit'); ?> --> 
                                                    </a>
                                                <?php } ?> 
                                                
                                                <?php if(has_permission(DELETE, 'leave', 'application')){ ?>    
                                                    <a href="<?php echo site_url('leave/application/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red;"><i class="fa fa-trash-o" style="font-size:20px"></i> 
                               ...
                               <?php echo form_open_multipart(site_url('leave/application/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <button id="send" type="submit" class="btn btn-success" style="background-color:blue"><?php echo $this->lang->line('submit'); ?></button>
                                    </div>
                                </div>
                                <?php echo form_close(); ?>
                            </div>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('leave/application/edit/'.$application->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <?php $this->load->view('layout/school_list_edit_form'); ?>  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($application->title) ?  $application->title : ''; ?>" placeholder="<?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>
