        ...
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bell-o" style="font-size: 25px"></i>&nbsp;<small style="font-size: 25px; font-weight: 600"> 
                    <!-- <?php echo $this->lang->line('manage_waiting_application'); ?> -->
                       Waiting Application 
                    </small></h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>                                                
                                                ...
                                                <?php if(has_permission(DELETE, 'leave', 'waiting')){ ?>    
                                                    <a href="<?php echo site_url('leave/waiting/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red"><i class="fa fa-trash-o" style="font-size:20px"></i> 
