...
<section class="content invoice profile_img">
   ...
   <div class="row">
       <div class="col-md-12 col-sm-12 col-xs-12 invoice-header_" style="text-align: center !important;">
           <address>
               <h3 style="color: black;font-weight:600"><?php echo $school->school_name; ?></h3>
   ...
   <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 invoice-header_" style="text-align: center !important;">
            <address>
                <h3 style="color:darkblue;font-weight: 400"><?php // echo $this->lang->line('student_copy'); ?><?php echo $value; ?></h3>                    
            </address>
        </div>            
    </div>
</section>    
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="btn-dark" style="padding: 5px;border-radius:4px"><?php echo $school->currency_symbol; ?><?php echo $receipt->net_amount-$paid_amount; ?></span></td>
                        </tr>                       
                    </tbody>
                </table>
            </div>
