        ...
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-calculator" style="font-size:25px"></i>&nbsp;<small style="font-size:25px;font-weight:600">
                 <!-- <?php echo $this->lang->line('manage_due_receipt'); ?> -->
                     Due Receipt
                 </small></h3>
                                   ...
                                   <tbody>   
                                       <?php $count = 1; if(isset($receipts) && !empty($receipts)){ ?>
                                           ...
                                           <tr>
                                               ...
                                               <td>
                                                  <a  onclick="get_due_receipt_modal(<?php echo $obj->school_id; ?>,<?php echo $obj->inv_id; ?>,<?php echo $obj->class_id; ?>,<?php echo $obj->section_id; ?>,<?php echo $obj->student_id; ?>);"  data-toggle="modal" data-target=".bs-receipt-modal-lg"  class="btn btn-success btn-xs" style="background-color:purple;"><i class="fa fa-eye" style="font-size:20px"></i> 
