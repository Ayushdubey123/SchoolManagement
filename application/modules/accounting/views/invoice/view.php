            ...
            <div class="x_content">
                ...
                <section class="content invoice">
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="btn-dark" style="padding: 5px; border-radius:5px"><?php echo $school->currency_symbol; ?><?php echo $invoice->net_amount-$paid_amount; ?></span></td>
                                        </tr>
                    ...
                    <div class="row no-print">
                        <div class="col-xs-12">
                            <button class="btn btn-default" onclick="window.print();" style="background-color:blue;color:white;"><i class="fa fa-print" style="color:white"></i> <?php echo $this->lang->line('print'); ?></button>
                            <?php if($invoice->paid_status != 'paid'){ ?>
                                <a href="<?php echo site_url('accounting/payment/index/'.$invoice->inv_id); ?>"><button class="btn btn-success pull-right" style="background-color:lightgreen;color:black;font-weight:500;"><i class="fa fa-credit-card" style="color:black;font-weight:500;"></i> <?php echo $this->lang->line('pay_now'); ?></button></a>
                            <?php } ?>
                        </div>
                    </div>
                </section>
