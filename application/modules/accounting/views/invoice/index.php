    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-leftt panel_toolbox">
                                            ...
                                            <td>
                                                <?php if(has_permission(VIEW, 'accounting', 'invoice')){ ?>
                                                    ...
                                                    <?php if($obj->paid_status != 'paid'){ ?>
                                                        <a href="<?php echo site_url('accounting/payment/index/'.$obj->id); ?>" class="btn btn-success btn-xs" style="background-color:lightgreen"><i class="fa fa-credit-card"></i> <?php echo $this->lang->line('pay_now'); ?></a>
                                                    <?php } ?>  
