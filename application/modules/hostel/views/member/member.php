        ...
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-hotel" style="font-size:25px"></i>&nbsp;<small style="font-size:25px;font-weight:600">
                 <!-- <?php echo $this->lang->line('manage_hostel_member'); ?> -->
                     Hostel Member
                 </small></h3>
                                        ...
                                        <tr  style="<?php if($obj->status_type !='regular'){ echo 'background:#dde3e8;';} ?>">
                                            ...
                                            <td>
                                                <?php if(has_permission(DELETE, 'hostel', 'member')){ ?>
                                                    <a href="<?php echo site_url('hostel/member/delete/'.$obj->hm_id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red"><i class="fa fa-trash-o" style="font-size:20px"></i> 
