<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa fa-calendar" style="font-size:25px"></i>&nbsp;<small style="font-size:25px"> 
                    <!-- <?php echo $this->lang->line('manage_event'); ?> -->
                        Event
                    </small></h3>
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($events) && !empty($events)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php  if($obj->image != ''){ ?>
                                                <img src="<?php echo UPLOAD_PATH; ?>/event/<?php echo $obj->image; ?>" alt="" width="80" style="border-radius:5px;" /> 
                                                <?php } ?>
                                            </td>
                                         <!--    <td><?php echo $obj->is_view_on_web ? $this->lang->line('yes') : $this->lang->line('no'); ?></td> -->
                                            <td>
                                                   ...
                                                   <?php if(has_permission(VIEW, 'event', 'event')){ ?>
                                                    <a  onclick="get_event_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-event-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size:20px"></i>
                                                     <!-- <?php echo $this->lang->line('view'); ?> -->
                                                      </a>
                                                <?php } ?>

                                                <?php if(has_permission(EDIT, 'event', 'event')){ ?>
                                                    <a href="<?php echo site_url('event/edit/'.$obj->id); ?>" class="btn btn-info btn-xs" style="background-color:blue;"><i class="fa fa-pencil-square-o" style="font-size:20px"></i> 
                                                        <!-- <?php echo $this->lang->line('edit'); ?> -->
                                                         </a>
                                                <?php } ?>
                                            
                                                <?php if(has_permission(DELETE, 'event', 'event')){ ?>
                                                    <a href="<?php echo site_url('event/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red;"><i class="fa fa-trash-o" style="font-size:20px"></i> 
