        ...
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-envelope-o" style="font-size:25px"></i>&nbsp;<small style="font-size:25px; font-weight:600"> 
                    <!-- <?php echo $this->lang->line('manage_email'); ?> -->
                            Email
                    </small></h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(VIEW, 'message', 'mail')){ ?>
                                                    <a  onclick="get_email_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-email-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye" style="font-size: 20px"> 
                                                        <!-- <?php echo $this->lang->line('view'); ?> --> 
                                                    </a>
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'message', 'mail')){ ?>    
                                                    <a href="<?php echo site_url('message/mail/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red;"><i class="fa fa-trash-o" style="font-size: 20px"></i>
