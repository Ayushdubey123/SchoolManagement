        ...
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-envelope-o" style="font-size:25px"></i><small style="font-size:25px; font-weight:600">
                 <!-- <?php echo $this->lang->line('manage_sms'); ?> -->
                     SMS
                 </small></h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(DELETE, 'message', 'text')){ ?>
                                                    <a href="<?php echo site_url('message/text/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs" style="background-color:red;"><i class="fa fa-trash-o" style="font-size:20px"></i> 
